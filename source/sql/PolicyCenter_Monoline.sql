-- ============================================================================
-- SCRIPT: PolicyCenter_Monoline.sql
-- DOMAIN: PolicyCenter / Commercial Lines Underwriting (Agribusiness)
-- PURPOSE: Extracts monoline policy transactions, premium breakdowns, agent
--          details, and job status within policy period and job close date ranges.
-- SOURCE TABLES:
...
-- TARGET: Monoline Policy Transaction Extract
-- ============================================================================
