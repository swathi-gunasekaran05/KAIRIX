-- ============================================================================
-- SCRIPT: ClaimCenter_CPP_Breakdown.sql
-- DOMAIN: ClaimCenter / Commercial Package Policy (CPP) Claims Breakdown
-- PURPOSE: Extracts Commercial Package Policy incurred losses, line of business
--          remapping (Business Owners -> BP7Line, Workers Comp), transaction
--          details, and financial amounts for incurred loss analysis.
-- SOURCE VIEWS:
...
-- TARGET: CPP Incurred Losses Summary by Policy and Remapped LOB
-- ============================================================================
